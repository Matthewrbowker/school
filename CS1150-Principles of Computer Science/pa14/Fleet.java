 ...
 * Creates and manages fleet of cars, now stored in an array and file writing capabilities
 */
...
public String remove(Car tempCar) {
  ...
  public int size() {
    ...
    public String generateBuffer() {
      while (cur < numCars){
        cur++;
        mainstring = mainstring + cars[cur].aboutMe() + "\n";
      }
      return mainstring;
    }
