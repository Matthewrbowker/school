 ...
 * Creates a new method that emulates driving a car - including a toString method and an aboutMe() method.
 */
...
public class Car {
  ...
  public String aboutMe() {
    return name + "|" + serialNumber + "|" + mileage + "|" + lastOilChange + "|" + fuelLevel + "|" + averageMPG;
  }
